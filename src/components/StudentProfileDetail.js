...
import { studentUpdate } from "../actions/student";
...
class StudentProfileDetail extends Component {
  ...
  onSubmit = event => {
    ...
    this.props.studentUpdate(id, { lstCode: this.state.colorCode });
    this.setState({
      remarks: "",
      UpdatedDate: new Date(),
      colorCode: ""
    ...
    return (
      <div>
        <StudentProfileForm
          ...
          onClickRed={this.onClickRed}
          onClickYellow={this.onClickYellow}
          values={this.state}
        />
        <br></br>
...
export default connect(
  mapStatesToProps,
  { deleteStudent, createProfile, studentUpdate }
